...
func makePathData(mapData *MapData) *PathData {
	...
	add := func(name, description, start string, startOffsetX, startOffsetY int, end string, endOffsetX, endOffsetY int) {
	...
	add("Spiny Rat Trade Route", "A well-established trade route for the transport of rare spices and textiles.", "Khida", -10, -4, "Gimi Kuuid", 0, 32)
